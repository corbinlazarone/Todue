    ...
    <div className="w-full max-w-7xl mx-auto px-4">
      <div className="grid md:grid-cols-3 gap-8">
        {plans.map((plan) => (
          <div
            key={plan.name}
            className="rounded-3xl p-8 border-2 border-indigo-500 bg-white shadow-lg hover:shadow-xl transition duration-300 relative overflow-hidden w-full flex flex-col"
          >
        ...
        {/* Enterprise Plan */}
        <div className="rounded-3xl p-8 border-2 border-indigo-500 bg-white shadow-lg hover:shadow-xl transition duration-300 relative overflow-hidden w-full flex flex-col">
          {/* Background gradient effect */}
          <div className="absolute inset-0 bg-gradient-to-br from-indigo-50 to-purple-50 opacity-50" />
